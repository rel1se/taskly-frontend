    ...
    return (
        <div className="flex items-center justify-center flex-col">
            <div className={cn("flex items-center justify-center flex-col", headingFont.className)}>
                ...
                from-fuchsia-600 to-pink-600 text-white px-4 p-2 rounded-xl pb-1 w-fit">
                    work forward.
                </div>
            </div>
            <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs " +
                "md:max-w-2xl text-center mx-auto", textFont.className)}>
                Collaborate, manage projects, and react new productivity peaks.
                From high rises to the home office, the way your team
                works is unique - accomplish it all with Taskly.
            </div>
